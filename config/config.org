...
** 其他一些包，需要预先进行配置的，主要包括 smex 这货
#+BEGIN_SRC emacs-lisp :tangle no
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; some packages need to be initialized
...
** 载入判断函数
该函数从 emacs24-start-kit 中拿过来的，主要是用来判断一个包是否安装，如果没有安
装，那么使用 elpa 方式来安装。在相关需要设置的地方，就可以直接用
=starter-kit-install-if-needed= 了。
#+BEGIN_SRC emacs-lisp
