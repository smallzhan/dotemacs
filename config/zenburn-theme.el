...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(org-level-1 ((,class (:foreground ,zenburn-orange :bold t :height 1.25))))
   `(org-level-2 ((,class (:foreground ,zenburn-green+1 :bold t :height 1.1))))
   `(org-level-3 ((,class (:foreground ,zenburn-blue-1 :bold t :height 1.0))))
