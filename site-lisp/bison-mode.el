...
;; http://tiny-tools.sourceforge.net/emacs-elisp-body.html#regexpopt.el_emacs
;(require 'make-regexp)			;; make-regexp
(require 'regexp-opt)			;; make-regexp
...
;;  (c-toggle-auto-state -1) <--- replaced with c-toggle-auto-newline
